...
### Open source library
The core PandaAI library is completely open source, giving you full control over your data processing and analysis workflows. Start with our [Data Layer Guide](/v3/data-layer) to learn about defining data schemas and creating integrated views.
