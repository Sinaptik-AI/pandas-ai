...
Both virtualized and materialized dataframes have a `.chat()` method that allows to interact with them using natural language. The dataframes can also be [shared with your team](/v3/share-dataframes) using our [Data Platform](/v3/ai-dashboards).