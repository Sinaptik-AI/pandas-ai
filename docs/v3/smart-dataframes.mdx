...
> **Note**: This documentation is for backwards compatibility. For new projects, we recommend using the new [semantic dataframes](/dataframes) API.
...
smart_df = SmartDataframe(df, config={
    ...
    "custom_whitelisted_dependencies": [],    # Additional allowed imports
