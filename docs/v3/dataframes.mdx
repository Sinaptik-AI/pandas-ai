...
Once you have turned raw data into semantic enhanced dataframes with the [semantic layer](/semantic-layer), you can load them locally as either materialized or virtualized dataframes. 
Using the `.chat` method, you can ask questions and get responses and charts. 
Both materialized and virtualized dataframes can be [shared with your team](/share-dataframes) by pushing them to our [data platform](/ai-dashboards).
