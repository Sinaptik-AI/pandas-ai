...
If you want to learn more about the platform, you can check out the [platform documentation](platform.mdx).
...
If you want to learn more about the library, you can check out the [library documentation](library.mdx).
