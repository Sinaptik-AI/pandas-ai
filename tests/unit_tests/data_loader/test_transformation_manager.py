...
class TestTransformationManager:
    def test_anonymize_email(self):
        ...
        df = pd.DataFrame({
            "email": ["user1@example.com", "user2@example.com", "test.user@domain.org"]
        })
    ...
    def test_anonymize_handles_na(self):
        ...
        df = pd.DataFrame({
            "email": ["user@example.com", None, pd.NA]
        })
    ...
    def test_replace(self):
        """Test replacing text."""
        df = pd.DataFrame({
            "text": ["hello world", "world hello", "hello hello"]
        })
    ...
    def test_extract(self):
        ...
        df = pd.DataFrame({
            "text": ["user123@example.com", "test456@domain.org"]
        })
    ...
    def test_truncate(self):
        ...
        df = pd.DataFrame({
            "text": ["very long text", "short", "another long text"]
        })
